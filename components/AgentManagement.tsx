              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-50">
                  {isLoading ? (
                          ...
                          <div className="flex items-center space-x-6">
                            {(['Harare', 'Bulawayo'] as Branch[]).map(branch => (
                              <button 
                                ...
                                className={`text-[10px] font-bold tracking-widest transition-all border-b-2 pb-1 uppercase ${
                                  agent.assignedBranch === branch 
                    ...
                    <tr>
                      <td colSpan={4} className="px-8 py-20 text-center text-gray-600 italic text-sm">
