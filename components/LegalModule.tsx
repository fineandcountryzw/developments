      ...
      <div className="flex bg-white p-1.5 rounded-2xl border border-fcDivider w-fit shadow-sm">
        {[
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-8 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest transition-all font-sans ${activeTab === tab.id ? 'bg-fcSlate text-white shadow-lg' : 'text-gray-600 hover:text-fcSlate'
              }`}
          >
            <tab.icon size={14} />
            <span>{tab.label}</span>
              ...
              <div className="p-2 space-y-1">
                {[
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-4 rounded-xl transition-all group ${vaultFolder === folder.id ? 'bg-fcGold/5 text-fcGold shadow-sm' : 'text-gray-600 hover:bg-white'
                      }`}
                  >
                ...
                <div className="space-y-8 animate-in zoom-in-95 duration-500">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {availableDocs.length === 0 && (
                      <div className="col-span-2 py-8 text-center opacity-30 text-sm">No statutory docs available for pick-up.</div>
                    )}
                  </div>
